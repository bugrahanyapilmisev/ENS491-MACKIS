...
KG_OUTPUT_DIR = os.getenv("KG_OUTPUT_DIR") or os.path.join(CREATING_KG_DIR, "knowledge_graph")
# Use validated files (cleaned by validate_kg_facts.py)
KG_FACTS_PATH = os.path.join(KG_OUTPUT_DIR, "kg_facts_validated.json")
KG_TRIPLES_PATH = os.path.join(KG_OUTPUT_DIR, "kg_triples_validated.json")
